...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                            <li class="nav-item">
                                <a class="nav-link text-dark" class="btn btn-outline-primary" href="login.php" >Iniciar Sesión</a>
                            </li>  
                    </ul>
                </div>
            </div>
    ...
    <div class="container sec-1 panel-7 text-center">
        <h2>Solicitud de información sobre precios de membresía</h2>
        <form name="formulario" action="procesar_formulario.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="mensaje" name="mensaje" required placeholder="Ingresa informacion que solicitas sobre las menbresías" class="form-control"></textarea><br><br>
                </div>
